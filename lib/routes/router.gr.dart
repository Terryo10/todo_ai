...
import 'package:todo_ai/ui/pages/todo/single_task_detail_page.dart' as _i4;
import 'package:todo_ai/ui/pages/todo/single_todo_page.dart' as _i5;
...
/// generated route for
/// [_i4.SingleTaskDetailPage]
class SingleTaskDetailRoute
    extends _i6.PageRouteInfo<SingleTaskDetailRouteArgs> {
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    ...
    builder: (data) {
      ...
      return _i4.SingleTaskDetailPage(
        key: args.key,
        todoId: args.todoId,
        taskId: args.taskId,
      );
...
/// generated route for
/// [_i5.SingleTodoPage]
class SingleTodoRoute extends _i6.PageRouteInfo<SingleTodoRouteArgs> {
  SingleTodoRoute({
    _i7.Key? key,
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    ...
    builder: (data) {
      ...
      return _i5.SingleTodoPage(key: args.key, todo: args.todo);
    },
  );
}
